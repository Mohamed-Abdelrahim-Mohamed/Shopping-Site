...
public class AddingToCartTest1 {
    WebDriver driver;
    Logger log;
    Exception exception;
    ...
    public void setUp(String timeout, String URL) throws IOException {
        ...
        log = new Logger(AddingToCartTest1.class.getSimpleName(),driver);
        log.prepareTest(AddingToCartTest1.class.getSimpleName());
    ...
    public void AddingToCartTest1() throws InterruptedException{
        try {
            ...
            log.step("Moving to Product");
            actions.moveToElement(Cart.Products.get(0)).build().perform();

            log.step("Adding Product to Cart");
            wait.until(ExpectedConditions.visibilityOf(Cart.ProductsButton.get(0))).click();
    ...
    public void tearDown(ITestResult testResult) throws Exception {
        log.logResults(testResult,AddingToCartTest1.class.getSimpleName(),exception,assertionError);
        driver.quit();
    }
}
