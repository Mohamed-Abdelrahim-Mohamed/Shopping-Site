...
public class SearchBar2 {
    ...
    public void setUp(String timeout, String URL) throws IOException {
        ...
        log = new Logger(SearchBar2.class.getSimpleName(),driver);
        log.prepareTest(SearchBar2.class.getSimpleName());
    ...
    public void tearDown(ITestResult testResult) throws Exception {
        log.logResults(testResult, SearchBar2.class.getSimpleName(),exception,assertionError);
        driver.quit();
    }
}
