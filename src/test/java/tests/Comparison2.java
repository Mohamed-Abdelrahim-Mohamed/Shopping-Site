...
public class Comparison2 {
    ...
    public void setUp(String timeout, String URL) throws IOException {
        ...
        log = new Logger(Comparison2.class.getSimpleName(),driver);
        log.prepareTest(Comparison2.class.getSimpleName());
    ...
    public void tearDown(ITestResult testResult) throws Exception {
        log.logResults(testResult, Comparison2.class.getSimpleName(),exception,assertionError);
        driver.quit();
    }
}
